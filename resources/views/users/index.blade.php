                    ...
                    <a href="{{ route('users.show', $user->username) }}" class="m-auto border hover:shadow-md w-full p-4 rounded">
                        <div class="m-auto">
                            ...
                            @if ($user->runner == "guide")
                                <img src="{{ asset('storage/images/icons/guide.svg') }}" alt="Guia" class="h-8 w-8 m-auto my-2">
                            @elseif ($user->runner == "athlete")
                                <img src="{{ asset('storage/images/icons/athlete.svg') }}" alt="Atleta" class="h-8 w-8 m-auto my-2">
                            @endif                            
                        </div>            
                    </a>
                @endforeach
